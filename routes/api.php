...
Route::middleware('jwt.auth')->group(function(){
    ...
    Route::post('/createApplicant', [LeaveController::class, 'createApplicant']);
    ...
    Route::get('/getMyLeaves', [LeaveController::class, 'getMyLeaves']);
    Route::get('/getLeaveReport/{leave_app_id}', [LeaveController::class, 'getLeaveReport']);
    ...
    // protected ps routes
    Route::group(['middleware' => ['roles.check:ps,admin']], function(){
        Route::put('/psApproveReject', [LeaveController::class, 'psApproveReject']);
        Route::put('/ammendPsApproval/{user_id}/{leave_app_id}', [LeaveController::class, 'ammendPsApproval']);      Route::get('/checkPsProfile/{user_id}', [LeaveController::class, 'checkHrmdProfile']);
  
    });
    // protected hrmd routes
    Route::group(['middleware' => ['roles.check:hrmd,admin']], function(){
